...
class Channel
{
  public:
    ...
    /**
     * @brief Fetch the IP address of the remote peer in bytes
     *
     * Returns the IP address of the remote peer which is connected to this
     * socket in bytes
     *
     * @return IP address of the remote peer in bytes
     */
    ...
    std::string getRemoteAddress()
    {
        ...
        else if (sockAddrSize == sizeof(sockaddr_in6))
        {
            ...
            // ipv6 address representation is like "::ffff:<ipv4_addr>"
            // Eg: ::ffff:255.255.255.255. So removing the prefix header and
            // passing ipv4 string to inet_addr().
