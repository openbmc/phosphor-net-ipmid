...
class Manager
{
    public:
         ...
         *
         */
        void startPayloadInstance(uint8_t payloadInstance, uint32_t sessionID);
        ...
        Context& getContext(uint8_t payloadInstance)
        {
            ...
            {
                throw std::runtime_error("Invalid SOL payload instance");
            }
         }
         ...
         *  @return reference to the SOL payload context.
         */
        Context& getContextSessionID(uint32_t sessionID)
        {
         ...
         */
        auto checkPayloadInst(uint8_t payloadInstance) const
        {
         ...
         */
        int writeConsoleSocket(const Buffer& input);
