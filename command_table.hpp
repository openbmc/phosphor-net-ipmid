...
/*
 * CommandFunctor_t is the functor register for commands defined in
 ...
 */
using CommandFunctor_t = std::function<std::vector<uint8_t>(
                             std::vector<uint8_t>&, MessageHandler&)> ;
