...
class Session
{
    public:
         ...
         *
         * @param[in] inIntegrityAlgo - unique pointer to integrity algorithm
         *                              instance
         */
        void setIntegrityAlgo(
                std::unique_ptr<cipher::integrity::Interface>&& inIntegrityAlgo)
        {
            integrityAlgoInterface = std::move(inIntegrityAlgo);
        }
    ...
    private:
        ...
        std::unique_ptr<cipher::integrity::Interface> integrityAlgoInterface = nullptr;
