...
class MessageParser
{
    public:
         ...
         * @param [out] Session header type in the packet is passed to the Message handler to sent
         *              response packet
         *
         * @return IPMI message in the packet on success
         */
        static std::unique_ptr<Message> unflatten(std::vector<uint8_t>& inPacket,
                SessionHeader& authType);

        /*
         * @brief Flatten an IPMI message and generate the IPMI packet with the session header
         *
