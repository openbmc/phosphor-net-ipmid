...
class Interface
{
    public:
         ...
         */
        std::vector<uint8_t> virtual generateHMAC(std::vector<uint8_t>& input) const =
            0;
         ...
         */
        std::vector<uint8_t> virtual generateICV(std::vector<uint8_t>& input) const = 0;
