...
class IpmiMessage
{
    ...
    protected:
        bool isFragment;  //Has the packet been read completely?

        IpmiMessageParser* parser;

        bool isPacketEncrypted;
        ...
        uint8_t* packet;
        bool     packetRequiresDelete;

        uint16_t payloadLength;
        uint8_t* payload;
        bool     payloadRequiresDelete;

        uint32_t integrityDataLength;
        uint8_t* integrityData;
        bool     integrityDataRequiresDelete;
};
